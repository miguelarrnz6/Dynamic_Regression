...
2. We are taking the actual values of $X$, and thus assuming it is really
3. exogenous. We should in fact build an univariate model for $X$ and
4. obtain forecasts from it.
